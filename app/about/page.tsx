      ...
      <section className="pt-32 pb-16 md:pt-48 md:pb-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-text-light leading-relaxed">
            Welcome to Calvary Baptist Church, where we&apos;re just ordinary
            people serving an extraordinary God. Our mission is to spread the
            good news of Jesus Christ and help people grow in their faith.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-text-light mb-6 leading-relaxed">
                At Calvary Baptist Church, we are committed to spreading the
                good news of Jesus Christ to our community and beyond. We
                believe in the power of God&apos;s word to transform lives and
                bring hope to those who need it most.
              </p>
              <p className="text-lg text-text-light leading-relaxed">
                Our church exists to help people discover their purpose in
                Christ, develop meaningful relationships, and make a difference
                in their communities through service and love.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-text-light leading-relaxed">
                ...
                the supreme authority for faith and practice.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <p className="text-text-light leading-relaxed">
                ...
                alone, not by works, and is available to all who believe.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-sm">
              <h3 className="text-2xl font-bold mb-3">The Church</h3>
              <p className="text-text-light leading-relaxed">
                We believe the church is the body of Christ, composed of all
                believers, and exists to worship God, edify believers, and
