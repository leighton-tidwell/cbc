...
const weeklyEvents = [
  {
    ...
    description:
      'Adult Sunday School classes for all stages of life and faith.',
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-text-light mb-6 leading-relaxed">
                Join us for contemporary worship and a practical message from
                Pastor Colton Grisham. Our Sunday morning service is designed to
                help you grow in your faith and connect with our church family.
              </p>
              <p className="text-lg text-text-light leading-relaxed">
                We offer nursery care for infants and toddlers, and
                Children&apos;s Church for ages 3-12. Come as you are and
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-text-light mb-8 leading-relaxed">
            Throughout the year, we host special events including revivals,
            holiday celebrations, community outreach programs, and youth
            activities. Follow us on social media or contact our office to stay
            updated on upcoming special events.
          </p>
          <div className="bg-gray-50 p-8 rounded-lg">
            <h3 className="text-2xl font-bold mb-4">Stay Connected</h3>
            <p className="text-text-light mb-4">
              Don&apos;t miss out on any of our events! Contact us for more
              information:
            </p>
            <p className="text-lg">
              <strong>Phone:</strong> 325.928.5120
              <br />
