...
export default function ServiceCard({ day, time, info, additional, image, alt, index }: ServiceCardProps) {
    ...
    >
      ...
      <div className="service-card-content relative z-[2] mt-auto bg-white p-12 text-center">
        ...
        <p className="service-info text-lg text-text-color font-medium leading-[1.5] font-primary">
          {info}
          <small className="block mt-1 text-sm text-text-light font-normal">{additional}</small>
        </p>
      </div>
    </div>
  );
