...
export default function Hero() {
  ...
  return (
    <section className="hero relative h-screen min-h-[600px] flex items-center justify-start overflow-hidden bg-bg-color">
      ...
      {/* Content Container */}
      <div className="container relative z-[2] w-full max-w-[1200px] mx-auto px-4 flex items-center h-full pt-[120px] 
        md:px-8 lg:px-16 
        max-[768px]:px-8 max-[768px]:pb-16 max-[768px]:items-center">
        <div className="hero-content max-w-[800px] w-full ml-0 px-8
          ...
          <Image 
            ...
            priority
          />
          <h1 className="hero-title font-heading font-black text-white leading-none mb-8 tracking-[-0.03em] drop-shadow-[0_4px_16px_rgba(0,0,0,0.4)]
          ...
          <p className="hero-subtitle font-light text-white mb-12 max-w-[600px] tracking-[0.01em] drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]
          ...
          {/* Buttons */}
          <div className="hero-buttons flex gap-4 justify-start flex-wrap
