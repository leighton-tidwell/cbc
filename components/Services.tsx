...
export default function Services() {
  ...
  return (
    <section
      className="section relative py-24 md:py-32 bg-white overflow-hidden"
      id="services"
    >
      ...
      <div className="container relative z-10 max-w-[1200px] mx-auto px-4">
        <h2
          className="section-title relative text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-center mb-16 pb-8 tracking-[-0.02em] text-text-color
